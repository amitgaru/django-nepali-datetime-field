...
The package is dependent on `nepali-datetime <https://github.com/amitgaru/nepali-datetime>`_ package, and the UI for the date picker is implemented from https://github.com/leapfrogtechnology/nepali-date-picker.
